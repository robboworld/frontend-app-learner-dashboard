...
const messages = defineMessages({
  ...
  pausedAt: {
    id: 'learner-dash.courseCard.CourseCardDetails.pausedAt',
    description: 'Message showing where the learner paused in the course',
    defaultMessage: 'You paused at: {title}',
  },
});
